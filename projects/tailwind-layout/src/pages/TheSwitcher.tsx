        ...
        <div className="center">
            <div className="stack">
                ...
                <div className="switcher switcher-max-child-4:basis-full">
                    ...
                    <div className="box bg-teal-600">C</div>
                    <div className="box bg-teal-600">D</div>
                    <div className="box bg-red-500/80">One too many</div>
                </div>
                <hr />
                <p>
                ...
                <div className="switcher">
                    <div className="box bg-teal-600">A</div>
                    <div className="box grow-[8] bg-red-500/80">B</div>
                    <div className="box bg-teal-600">C</div>
                </div>
                <p>
                ...
                <div className="switcher">
                    <div className="box grow-[5] bg-red-500/80">A</div>
                    <div className="box bg-teal-600">B</div>
                    <div className="box bg-teal-600">C</div>
                </div>
                <p>
                ...
                <div className="switcher">
                    <div className="box bg-teal-600 ">A</div>
                    <div className="box bg-teal-600">B</div>
                    <div className="box grow-[2] bg-red-500/80 ">C</div>
                </div>
            </div>
        </div>
    );
