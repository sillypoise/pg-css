export function TheReel() {
    return (
        <div className="stack">
            ...
            <div className="reel [--reel-item-width:40ch]">
                <div className="box p-3xl">A</div>
                <div className="box p-3xl">B</div>
                <div className="box p-3xl">C</div>
                <div className="box p-3xl">D</div>
            ...
            <p>
                E.g. &nbsp;(
                <code>{`--reel-gap: theme(spacing.2xl)`}</code>)
            </p>
            <div className="reel [--reel-gap:theme(spacing.2xl)]">
                <div className="box p-3xl">A</div>
                <div className="box p-3xl">B</div>
                <div className="box p-3xl">C</div>
                <div className="box p-3xl">D</div>
            ...
            <p>
                E.g. &nbsp;(
                <code>{`--reel-item-margin: theme(spacing.l)`}</code>)
            </p>
            <div className="reel [--reel-item-margin:theme(spacing.l)]">
                <div className="box p-3xl">A</div>
                <div className="box p-3xl">B</div>
                <div className="box p-3xl">C</div>
                <div className="box p-3xl">D</div>
            ...
            <div className="reel [--reel-border:0]">
                <div className="box p-3xl">A</div>
                <div className="box p-3xl">B</div>
                <div className="box p-3xl">C</div>
                <div className="box p-3xl">D</div>
